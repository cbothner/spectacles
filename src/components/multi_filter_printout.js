...
const MultiFilterPrintout = ({filters}) => <main>
  {filters.map( filter => <div className="page">
    <div style={{display: "flex"}}>
      <div className="pt-control-group pt-vertical">
        <InputGroup leftIconName='flash' placeholder="Name" value={filter.name}
          rightElement={
            <Button
        ...
        <InputGroup leftIconName='dollar' placeholder="Base Price"
          value={filter.basePrice} type="number" step="0.01"/>
        <InputGroup leftIconName='tint' placeholder="Color" value={filter.color} />
        <InputGroup leftIconName='resolve' placeholder="VLT" value={filter.vlt}
          type="number"
          rightElement={
